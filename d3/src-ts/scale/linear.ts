...
/// <reference path="../interpolate/interpolate.ts" />
/// <reference path="../interpolate/round.ts" />
/// <reference path="../interpolate/uninterpolate.ts" />
/// <reference path="../format/format.ts" />
/// <reference path="../math/abs.ts" />
/// <reference path="bilinear.ts" />
/// <reference path="nice.ts" />
/// <reference path="polylinear.ts" />
